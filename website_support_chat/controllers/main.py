...
class Website_Chat(openerp.addons.web.controllers.main.Home):
    ...
    def get_values(self):
        ...
        webs_talkus_id = icp.get_param(request.cr, request.uid, 'website_talkus')
        webs_talkus = request.registry['website.talkus'].browse(request.cr,request.uid,int(webs_talkus_id))
