...
class TestWebsiteSale(HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.env.ref('payment.payment_provider_transfer').write({'state': 'test', 'is_published': True})
        cls.env.ref('payment.payment_provider_demo').write({'state': 'test', 'is_published': True})
