...
tour.register('website_sale_tour_wire_transfer', {
    ...
    [
        ...
        },
        {
            ...
            trigger: '.btn.btn-primary.float-end',
            run: "click"
        },
        {
            content: "Select Wire Transfer as the payment method.",
            trigger: 'div:contains("Transferencia bancaria") input',
            run: "click"
        },
        {
        ...
        {
            content: "finish",
            trigger: "strong:contains('Información del Pago:')",
            run: function () {
        ...
        },
        {
            ...
            trigger: 'h1:contains("Contáctenos")',
            run: function () {}, // it's a check
        },
    ]
);
