...
class ProductTemplate(models.Model):
    ...
    def _get_first_available_combination(self):
        ...
        available_ids = self._get_available_variant_ids()
    ...
    def _get_available_variant_ids(self):
        """Return the ids of the variants of this template that have stock.
    ...
    def _has_any_variant_available(self):
        """Return whether at least one variant of this template can still be sold."""
        self.ensure_one()
        return bool(self._get_available_variant_ids())
