...
class GetOPertionByIdTest(TestCase):
	...
	def test_get_ok(self, MockTodoPagoConnector):
		...
		responseOperation = MTPConnector.getByOperationId(instanceOperationBId.get_operation_by_id_params())

		self.assertEquals(responseOperation['OperationsColections']['Operations']['RESULTCODE'], -1)
	...
	def test_get_operation_fail(self, MockTodoPagoConnector):
		...
		responseOperation = MTPConnector.getByOperationId(instanceOperationBId.get_operation_by_id_params_merchant_null)	
	...
	def test_get_operation_702(self, MockTodoPagoConnector):
		...
		self.assertEquals(responseOperation['OperationsColections']['Status'], 702)
	...
	def test_get_operation_merchant_null(self, MockTodoPagoConnector):
		...
		self.assertEquals(responseOperation['OperationsColections']['Status'], 1014)	
